...
import * as classes from './menu.module.less';
...
const MenuElem = ({ href, text, onClick }: MenuElemProps) => (
  <li className={classes.menu__elem}>
    <Link
      className={classes.menu__elem__link}
      to={`/${href || ''}`}
      onClick={onClick}
    >
      {text}
...
const Menu = ({ categories, menuOpen, toggleMenu, closeMenu }: MenuProps) => {
        ...
        <ul className={classes.menu__elems}>
          ...
          <li
            className={classNames(
              classes.menu__elem,
              classes.menu__elem__icons
            )}
          >
            <OutboundLink href="https://www.facebook.com/dstuan">
              <svg
                className={classNames(
                  classes.menu__elem__icon,
                  classes.menu__elem__iconFacebook
                )}
                viewBox="0 0 512 512"
              >
            ...
            <OutboundLink href="https://www.instagram.com/dagstuan/">
              <svg className={classes.menu__elem__icon} viewBox="0 0 512 512">
                <g>
